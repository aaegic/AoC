...
while 1:
    ...
    _pm2 = (ic[_pos] / 10000).__trunc__() % 10
    ...
    if _oc == 1:
        if _pm0:
            ...
            __opand0 = ic[ic[_pos+1]]

        if _pm1:
            __opand1 = ic[_pos+2]
        else:
            __opand1 = ic[ic[_pos+2]]

        ic[ic[_pos+3]] = __opand0 + __opand1
        _pos += 4
